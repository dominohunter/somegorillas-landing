...
export const appTemplate = `<div class="flex flex-col justify-center">
  ...
  <nav class="flex w-full justify-center absolute top-0 left-0 right-0 z-20">
      ...
      >
        ...
        <button onclick="window.open('https://app.somegorillas.com', '_blank')" class="bg-light-primary border-none text-white h-12 lg:h-14 px-3 sm:px-5 font-bold text-sm sm:text-lg hover:text-accent-primary transition-colors duration-300 rounded">
        Go to Cave
        </button>
